<template>
	<view class="u-section">
		...
		<u-tag :text="tagText" :type="tagType" :show="showTag" shape="circle" ></u-tag>
...
<script>
	 ...
	 * @property {String} tag 标签内容（默认“tag”）////
	 * @property {Boolean}showTag 是否显示标签（默认否）////
	 * @property {String}tagType tag的类型（默认info）////
	 * @property {String} tagText tag上的字（默认“普通”）////
