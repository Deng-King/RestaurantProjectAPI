<template>
	<view>
		<u-dropdown style="border-bottom: dashed #C0C0C0 thin;">
			<u-dropdown-item v-model="value" title="编辑" :options="options" @change="edit()"></u-dropdown-item>
		</u-dropdown>
			...
			return {
				noticelist: [{
					...
					},
					{
						...
						user_name: "发布人",
						notice_create_notice_create_time: "2021/7/10 9:32:30",
						priority: "重要",
					},
					{
						title: "我是大标题",
		...
		methods: {
			...
			edit() {
				...
				switch (this.value) {
					case (1):
						uni.navigateTo({
							url: '../notice/noticeaddcontent/noticeaddcontent'
						});
						break;
				}
				this.value = 0;
